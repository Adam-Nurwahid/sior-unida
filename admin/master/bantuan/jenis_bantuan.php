...
$query = "SELECT * FROM master_jenis_bantuan ORDER BY id DESC";
...
<div class="flex-grow-1 p-4 bg-light">
    ...
    <nav class="navbar navbar-light bg-white shadow-sm mb-4 rounded">
        <div class="container-fluid">
            <span class="navbar-brand mb-0 h1">Jenis Bantuan</span>
        </div>
    </nav>
    ...
    <div class="card shadow-sm border-0">
        ...
        <td class="text-center">
            <button class="btn btn-sm btn-warning text-white" 
                    onclick="bukaModalEdit('<?= $row['id']; ?>', '<?= $row['kode']; ?>', '<?= $row['nama_jenis_bantuan']; ?>')">
                <i class="fas fa-edit"></i>
            </button>
            <a href="hapus.php?id=<?= $row['id']; ?>&type=jenis_bantuan" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus data ini?')">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel">Form Jenis Bantuan</h5>
      ...
      <form action="proses_simpan.php" method="POST">
          <div class="modal-body">
            ...
            <div class="mb-3">
                <label for="inputNama" class="form-label">Nama Jenis Bantuan</label>
