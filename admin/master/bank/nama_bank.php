...
// --- 2. LOGIKA DATA (Simulasi Database) ---
// Nanti bagian ini diganti dengan query mysqli_query()
$query = "SELECT * FROM master_nama_bank ORDER BY id DESC";
...
<div class="flex-grow-1 p-4 bg-light">
    ...
    <nav class="navbar navbar-light bg-white shadow-sm mb-4 rounded">
        <div class="container-fluid">
            <span class="navbar-brand mb-0 h1">Nama Bank SIPANDAI</span>
        </div>
    </nav>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-sm btn-warning text-white" 
                                        onclick="bukaModalEdit('<?= $row['id']; ?>', '<?= $row['kode']; ?>', '<?= $row['nama_bank']; ?>')">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel">Form Nama Bank</h5>
      ...
      <form action="proses_simpan.php" method="POST">
          <div class="modal-body">
            ...
            <div class="mb-3">
                <label for="inputNama" class="form-label">Nama Bank</label>
                <input type="text" class="form-control" id="inputNama" name="nama" required placeholder="Masukkan nama Bank">
            </div>
...
<script>
    ...
    function bukaModalTambah() {
        document.getElementById('modalLabel').innerText = "Tambah Jenis Bank";
