...
if (isset($_POST['simpan'])) {
    ...
    $simpan = mysqli_query($koneksi, "INSERT INTO mst_jenis_bantuan (kode, nama) VALUES ('$kode', '$nama')");

    if ($simpan) {
        echo "<script>alert('Data Berhasil Disimpan!'); window.location='mst_bantuan.php';</script>";
    } else {
            ...
            <div class="container" style="max-width: 600px;">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Tambah Jenis Bantuan</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between"> <a href="mst_bantuan.php" class="btn btn-secondary">KELUAR</a>
