...
if (isset($_POST['simpan'])) {
    ...
    $simpan = mysqli_query($koneksi, "INSERT INTO mst_jenis_jabatan (kode, nama) VALUES ('$kode', '$nama')");
...
<html>
<head>
    <title>Tambah Jenis Lokasi</title>
            ...
            <div class="container" style="max-width: 600px;">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Tambah Jenis Lokasi</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
