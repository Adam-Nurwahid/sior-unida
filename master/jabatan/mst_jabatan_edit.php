...
// Ambil ID dari URL
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM mst_jenis_jabatan WHERE id='$id'");
...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE mst_jenis_jabatan SET kode='$kode', nama='$nama' WHERE id='$id'");
            ...
            <div class="container" style="max-width: 600px;">
                <div class="card shadow">
                    <div class="card-header bg-warning text-white">
                        <h5 class="mb-0">Edit Jenis Lokasi</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Nama Jenis Lokasi</label>
