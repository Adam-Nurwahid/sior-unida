...
// Ambil ID dari URL
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM mst_jenis_lokasi WHERE id='$id'");
...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE mst_jenis_lokasi SET kode='$kode', nama='$nama' WHERE id='$id'");
