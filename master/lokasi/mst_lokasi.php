...
<html lang="id">
<head>
    <title>Master Lokasi - SIOR UNIDA</title>
    ...
    <div class="d-flex">
        ...
        <div class="p-4 w-100 bg-light" style="height: 100vh; overflow-y: auto;">
            <div class="container-fluid">
                <h2 class="mb-4 fw-bold text-primary">Master Jenis Lokasi</h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * FROM mst_jenis_lokasi ORDER BY kode ASC");
